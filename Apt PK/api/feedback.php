...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'reply') {
        ...
        if ($report && $report['reporter_phone']) {
            sendSMS($report['reporter_phone'], "Dear " . $report['reporter_name'] . ", your report has been updated by PK's Luxury Apartments management. Check your account for details.");
        }
