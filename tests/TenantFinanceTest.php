...
final class TenantFinanceTest extends DatabaseTestCase
{
    ...
    {
        [$tenantId] = $this->makeTenantWithApartment('arr1', 1000, date('Y-m-01'));
    ...
    {
        [$tenantId] = $this->makeTenantWithApartment('arr2', 1000, date('Y-m-d', strtotime('-3 months')));
    ...
    {
        [$tenantId, $apartmentId] = $this->makeTenantWithApartment('arr3', 1000, date('Y-m-d', strtotime('-3 months')));
        $this->addCompletedPayment($tenantId, $apartmentId, date('Y-m', strtotime('-1 month')), 3000);
    ...
    {
        [$tenantId, $apartmentId] = $this->makeTenantWithApartment('arr4', 1000, date('Y-m-d', strtotime('-2 months')));
        $this->addCompletedPayment($tenantId, $apartmentId, date('Y-m'), 3000);
    ...
    {
        [$tenantId, $apartmentId] = $this->makeTenantWithApartment('arr5', 1000, date('Y-m-01'));
        $this->addCompletedPayment($tenantId, $apartmentId, date('Y-m', strtotime('+2 months')), 1000);
    ...
    {
        [$tenantId] = $this->makeTenantWithApartment('range1', 1000, date('Y-m-01'));
    ...
    {
        [$tenantId, $apartmentId] = $this->makeTenantWithApartment('range2', 1000, date('Y-m-01'));
        $this->addCompletedPayment($tenantId, $apartmentId, '2026-01', 1000);
    ...
    {
        [$tenantId, $apartmentId] = $this->makeTenantWithApartment('range3', 1000, date('Y-m-01'));
        $this->addCompletedPayment($tenantId, $apartmentId, '2026-01', 1000);
        $this->addCompletedPayment($tenantId, $apartmentId, '2026-02', 1000);
        $this->addCompletedPayment($tenantId, $apartmentId, '2026-03', 1000);
    ...
    {
        [$tenantId, $apartmentId] = $this->makeTenantWithApartment('month1', 1000, date('Y-m-01'));
        $this->addCompletedPayment($tenantId, $apartmentId, '2026-03', 1000);
        $this->addCompletedPayment($tenantId, $apartmentId, '2026-01', 1000);
        $this->db->prepare("INSERT INTO rent_payments (tenant_id, apartment_id, amount, payment_date, payment_method, month_covered, status) VALUES (?, ?, 1000, CURDATE(), 'cash', '2026-02', 'failed')")
    ...
    {
        [$tenantId] = $this->makeTenantWithApartment('next1', 1000, date('Y-m-01'));
    ...
    {
        [$tenantId, $apartmentId] = $this->makeTenantWithApartment('next2', 1000, date('Y-m-01'));
        $futureMonth = date('Y-m', strtotime('+3 months'));
        $this->addCompletedPayment($tenantId, $apartmentId, $futureMonth, 1000);
